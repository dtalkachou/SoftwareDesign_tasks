...
public class BoardGridView extends View implements
        GameInitializer.OnUpdateListener {
    ...
    public BoardGridView(Context context, AttributeSet attrs) {
        ...
        mFieldPaint.setColor(args.getColor(R.styleable.BoardGridView_fieldColor, 0));
